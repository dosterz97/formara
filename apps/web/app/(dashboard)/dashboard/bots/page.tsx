				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{loading ? (
						...
						<>
							...
							{/* Create New Bot Card */}
							<div
								className="group bg-white rounded-lg shadow-sm border border-dashed border-gray-300 hover:shadow-md hover:border-indigo-300 transition-all duration-200 cursor-pointer"
								onClick={() => setIsCreateModalOpen(true)}
							>
								<div className="p-6 flex flex-col items-center justify-center h-full min-h-[280px]">
									...
									<h2 className="text-xl font-semibold text-gray-700 group-hover:text-indigo-600 transition-colors text-center">
										Create New Bot
									</h2>
