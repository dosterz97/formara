...
// Enums
export const statusEnum = pgEnum('status', ['active', 'inactive', 'deceased', 'historical', 'conceptual', 'unknown']);
export const entityTypeEnum = pgEnum('entity_type', ['character', 'location', 'item', 'event', 'concept', 'organization', 'other']);
...
export const universes = pgTable('universes', {
  ...
  return [{
    teamSlugIdx: uniqueIndex('universe_team_slug_idx').on(table.teamId, table.slug),
  }]
});
...
export const entities = pgTable('entities', {
  ...
  return [{
    universeEntityIdx: uniqueIndex('universe_entity_idx').on(table.universeId, table.entityType, table.slug),
  }]
});
...
export const metaverseActivityLogsRelations = relations(metaverseActivityLogs, ({ one }) => ({
  universe: one(universes, {
